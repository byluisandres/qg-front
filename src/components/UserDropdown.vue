    ...
    <Menu as="div" class="relative inline-block text-left z-50">
        <div>
            <MenuButton
                ...
                <span>luisandres33@gmail.com</span>
            ...
            <MenuItems
                ...
                <div class="px-1 py-1">
                    ...
                    <button :class="[
                        ...
                        <OfficeBuildingIcon class="mr-2 h-5 w-5" aria-hidden="true" />
                        Empresa
                    </button>
                    </MenuItem>
                </div>
                <div class="px-1 py-1">
                    ...
                    <button :class="[
                        ...
                        <LogoutIcon class="mr-2 h-5 w-5" aria-hidden="true" />
                        Salir
                    </button>
                    </MenuItem>
                </div>
...
import { ChevronDownIcon, UserIcon, LogoutIcon, OfficeBuildingIcon } from '@heroicons/vue/solid'
export default {
    name: "user-dropdown",
    components: {
        Menu,
